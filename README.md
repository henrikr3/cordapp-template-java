...
A CorDapp template in Java which includes Accounts SDK and Tokens SDK

In essence, we have here the template extended with the Accounts SDK and the Tokens SDK and some common flows that show how to use both accounts and tokens.

See below for the original README.md from the original source at:
